...
public class StoreIncMenu extends Panel {
	...
	public StoreIncMenu(StorePage storePage) {
		super(storePage);

		// create
		p_title = new JPanel();
		lb_title = new JLabel("아이앤씨점");

		p_details = new JPanel();

		table = new JTable(storesModel = new StoresModel("아이앤씨점"));
		scroll = new JScrollPane(table);

		branchDAO = new BranchDAO();
		list = branchDAO.selectBranchDetail("아이앤씨점");
