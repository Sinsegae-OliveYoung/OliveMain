...
public class StoreBongMenu extends Panel {
	...
	public StoreBongMenu(StorePage storePage) {
		super(storePage);

		// create
		p_title = new JPanel();
		lb_title = new JLabel("봉은사점");

		p_details = new JPanel();

		table = new JTable(storesModel = new StoresModel("봉은사점"));
		scroll = new JScrollPane(table);

		branchDAO = new BranchDAO();
		list = branchDAO.selectBranchDetail("봉은사점");
