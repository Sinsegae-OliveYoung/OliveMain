...
public class StoreSinMenu extends Panel {
	...
	public StoreSinMenu(StorePage storePage) {
		super(storePage);

		// create
		p_title = new JPanel();
		lb_title = new JLabel("신세계점");

		p_details = new JPanel();

		table = new JTable(storesModel = new StoresModel("신세계점"));
		scroll = new JScrollPane(table);

		branchDAO = new BranchDAO();
		list = branchDAO.selectBranchDetail("신세계점");
