...
public class StoreSamMenu extends Panel {
	...
	public StoreSamMenu(StorePage storePage) {
		super(storePage);

		// create
		p_title = new JPanel();
		lb_title = new JLabel("삼성점");

		p_details = new JPanel();

		table = new JTable(storesModel = new StoresModel("삼성점"));
		scroll = new JScrollPane(table);

		branchDAO = new BranchDAO();
		list = branchDAO.selectBranchDetail("삼성점");
