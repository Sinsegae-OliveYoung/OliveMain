			...
			public void actionPerformed(ActionEvent e) {
				...
				if (mainLayout.user.getRole().getRole_id() == 3) {
					...
					if (productImg != null) {
						...
						String imgUrl = "http://192.168.60.36:8282/public/" + fileName;
...
//							BufferedImage bufferedImage = ImageIO.read(imgFile);
						    ...
						    BufferedImage image = ImageIO.read(url); // 이미지 다운로드
						    ...
						    e1.printStackTrace();
						    JOptionPane.showMessageDialog(ProductListPanel.this, "이미지를 불러오는 데 실패했습니다.");
						}
...
//                }
	...
	public void upload() {
		...
		/* 서버로 전송할 데이터 구성하기 */
		StringBody titleBody = new StringBody(tfName.getText(), ContentType.create("text/plain", Consts.UTF_8));
